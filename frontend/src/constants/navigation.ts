...
export const sidebarNavItems: SidebarNavItem[] = [
  ...
  // 我的工作台
  { group: '我的工作台', groupOrder: 1, path: '/my-todos', label: '個人待辦案件', title: '個人待辦案件', icon: 'assignment', disabled: true },

  // 保單管理
  { group: '保單管理', groupOrder: 2, path: '/policies', label: '保單查詢', title: '保單查詢', icon: 'description' },
  { group: '保單管理', groupOrder: 2, path: '/policies/review', label: '保單審核', title: '保單審核', icon: 'fact_check', disabled: true },
  { group: '保單管理', groupOrder: 2, path: '/updTime', label: '重新安排約訪時間', title: '重新安排約訪時間', icon: 'schedule' },
  { group: '保單管理', groupOrder: 2, path: '/policies/progress', label: '投保進度歷程', title: '投保進度歷程', icon: 'history', disabled: true },
  ...
  // 商品管理
  { group: '商品管理', groupOrder: 4, path: '/products', label: '商品維護', title: '商品維護', icon: 'inventory_2', disabled: true },
